...
// func NewGameHandler(r *http.Quest) error {
// 	gameid := ""
// 	if r.Session == nil {
...
// 		vii.NotificationService.Add(r.Username, "error", "New Game", "Your deck must have at least 21 cards")
...
// 	r.Agent.WriteJson(game.Json(r.Session.Username))
// 	return nil
// }
