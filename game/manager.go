...
// 		game = New(key, rules, logger)
// 		set(key, game)
// 	})

// 	deck1, err := deck.BuildNew(e1.Writer().Name(), e1.Deck(), m.settings.Content.GetCards())
// 	if err != nil {
// 		return
// 	}
// 	deck2, err := deck.BuildNew(e2.Writer().Name(), e2.Deck(), m.settings.Content.GetCards())
// 	if err != nil {
// 		return
// 	}
